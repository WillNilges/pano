...
alias pano_garage="podman exec -it pano-dev_garage_1 /garage"
...
pano_garage bucket create pano-bucket
pano_garage bucket info pano-bucket
pano_garage key create pano-app-key
pano_garage bucket allow --read --write --owner pano-bucket --key pano-app-key
